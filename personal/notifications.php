                        ...
                        switch ($row['notification_type']) {
                            ...
                            case "cycle_overspent":
                                ...
                                if ($row['account_type'] == 1) {
                                    ...
                                    $message = "You have overspent on your recent cycle, having ₱" .$row['savings']. "  budget from <strong>" . date("F jS, Y", strtotime($row['start'])) ."</strong> to <strong>" .date("F jS, Y", strtotime($row['end'])). "</strong> , add more budget on your next cycle to prevent over spending.";
                                } elseif ($row['account_type'] == 3) {
